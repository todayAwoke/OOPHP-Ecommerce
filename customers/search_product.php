        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-info">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"> <i class="fa-solid fa-cart-shopping"><sup>4</sup></i></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row">
            <div class="col-md-10 ">
                ...
                <div class="row">
                    <!-- fetching Products -->
                    <?php
                    $get_product =new Commen_method();
                    $get_product->search_product();
                    $get_product->get_unique_brand();
                    ?>
                </div>
            </div>
